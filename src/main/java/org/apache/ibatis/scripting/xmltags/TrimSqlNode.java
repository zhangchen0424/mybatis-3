  ...
  private class FilteredDynamicContext extends DynamicContext {
    ...
    public void applyAll() {
      ...
      sqlBuffer = new StringBuilder(sqlBuffer.toString().trim());
        // <2> 将 sqlBuffer 大写，生成新的 trimmedUppercaseSql 对象。为什么呢？
        // 因为，TrimSqlNode 对 prefixesToOverride 和 suffixesToOverride 属性，都进行了大写的处理，需要保持统一。但是，又不能直接修改 sqlBuffer ，因为这样就相当于修改了原始的 SQL
